...
The native iPhone client is in [ios/README.md](ios/README.md). It looks up flights directly from FlightAware AeroAPI, stores tracked flights on the iPhone, and leaves the web app and server in place for web users.
